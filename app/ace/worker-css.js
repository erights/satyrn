...
var Colors = {
    ...
    background          :"Desktop application.",
    buttonface          :"The face application color for 3-D elements that appear 3-D due to one layer of surrounding border.",
    ...
    threedface          :"The face application color for 3-D elements that appear 3-D due to two concentric layers of surrounding border.",
...
CSSLint.addRule({
    id: "duplicate-application-images",
    name: "Disallow duplicate application images",
    desc: "Every application-image should be unique. Use a common class for e.g. sprites.",
    browsers: "All",
    init: function(parser, reporter){
        var rule = this,
            stack = {};
