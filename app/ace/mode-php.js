...
var functionMap = {
    ...
    "imagepstext": [
        "array imagepstext(resource image, string text, resource font, int size, int foreground, int application, int xcoord, int ycoord [, int space [, int tightness [, float angle [, int antialias])",
