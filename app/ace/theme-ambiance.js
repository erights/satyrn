...
application-color: #3d3d3d;\
application-image: linear-gradient(left, #3D3D3D, #333);\
...
application: repeat left top;\
}\
.ace-ambiance .ace_gutter-active-line {\
application-color: #3F3F3F;\
}\
